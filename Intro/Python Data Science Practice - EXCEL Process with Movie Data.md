...
1. understand how to process excel file in python.
2. install packages which help to process excel file. 
2. understand how pandas can help to read/produce excel files.
3. practice with the Movie dataset from Kaggle IMDB data. 
    1. practice pandas reading file into dataframe.
    2. practice dataframe manipulation: plot chart, multiindex, pivot_table.
    3. practice data output
