...
1. understand what is csv format files, and using excel to view csv files. 
2. understand how pandas can help to read/produce csv files.
3. practice with the MovieTweetings dataset. 
    1. practice pandas reading file into dataframe.
    2. practice dataframe manipulation: groupby, agg, selection, count, etc.
    3. practice merge of 2 dataframes.
    4. practice ploting.
